...
class PermissionsController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('permission.index')->withSuccess(trans('app.permission_deleted_successfully'));
    }
    ...
    public function saveRolePermissions(Request $request)
    {
        ...
        Cache::flush();
        return redirect()->route('permission.index')->withSuccess(trans('app.success_update'));
    }
}
