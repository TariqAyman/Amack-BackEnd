...
CREATE TABLE `cities` (
  ...
  `is_dive` tinyint(1) NOT NULL DEFAULT '1',
  ...
  `emergency_latitude` decimal(10,8) DEFAULT NULL,
  `emergency_longitude` decimal(11,8) DEFAULT NULL,
  `rate` int(11) NOT NULL DEFAULT '0',
  `enabled` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `peak_season_id` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cities_country_id_foreign` (`country_id`),
  KEY `cities_peak_season_id_foreign` (`peak_season_id`),
  CONSTRAINT `cities_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE CASCADE,
  CONSTRAINT `cities_peak_season_id_foreign` FOREIGN KEY (`peak_season_id`) REFERENCES `seasons` (`id`) ON DELETE CASCADE
...
CREATE TABLE `city_images` (
  ...
  PRIMARY KEY (`id`),
  KEY `city_images_city_id_foreign` (`city_id`),
  CONSTRAINT `city_images_city_id_foreign` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `city_top_sites`
--

DROP TABLE IF EXISTS `city_top_sites`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `city_top_sites` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `city_id` bigint(20) unsigned NOT NULL,
  `dive_site_id` bigint(20) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `city_top_sites_city_id_foreign` (`city_id`),
  KEY `city_top_sites_dive_site_id_foreign` (`dive_site_id`),
  CONSTRAINT `city_top_sites_city_id_foreign` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`) ON DELETE CASCADE,
  CONSTRAINT `city_top_sites_dive_site_id_foreign` FOREIGN KEY (`dive_site_id`) REFERENCES `dive_sites` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `countries` (
  ...
  `latitude` decimal(10,8) DEFAULT NULL,
  `longitude` decimal(11,8) DEFAULT NULL,
  `enabled_for_dive` tinyint(1) NOT NULL DEFAULT '1',
  `enabled_for_signup` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `dive_activities`
--

DROP TABLE IF EXISTS `dive_activities`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dive_activities` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `icon` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `dive_entries`
--

DROP TABLE IF EXISTS `dive_entries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dive_entries` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `photo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Table structure for table `dive_site_activities`
--

DROP TABLE IF EXISTS `dive_site_activities`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dive_site_activities` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `dive_site_id` bigint(20) unsigned NOT NULL,
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `dive_site_activities_dive_site_id_foreign` (`dive_site_id`),
  KEY `dive_site_activities_activity_id_foreign` (`activity_id`),
  CONSTRAINT `dive_site_activities_activity_id_foreign` FOREIGN KEY (`activity_id`) REFERENCES `dive_activities` (`id`) ON DELETE CASCADE,
  CONSTRAINT `dive_site_activities_dive_site_id_foreign` FOREIGN KEY (`dive_site_id`) REFERENCES `dive_sites` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `dive_site_day_times`
--

DROP TABLE IF EXISTS `dive_site_day_times`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dive_site_day_times` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `dive_site_id` bigint(20) unsigned NOT NULL,
  `day_time_id` bigint(20) unsigned NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `dive_site_day_times_dive_site_id_foreign` (`dive_site_id`),
  KEY `dive_site_day_times_day_time_id_foreign` (`day_time_id`),
  CONSTRAINT `dive_site_day_times_day_time_id_foreign` FOREIGN KEY (`day_time_id`) REFERENCES `day_times` (`id`) ON DELETE CASCADE,
  CONSTRAINT `dive_site_day_times_dive_site_id_foreign` FOREIGN KEY (`dive_site_id`) REFERENCES `dive_sites` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `dive_site_entries`
--

DROP TABLE IF EXISTS `dive_site_entries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dive_site_entries` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `dive_site_id` bigint(20) unsigned NOT NULL,
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `dive_site_entries_dive_site_id_foreign` (`dive_site_id`),
  KEY `dive_site_entries_entry_id_foreign` (`entry_id`),
  CONSTRAINT `dive_site_entries_dive_site_id_foreign` FOREIGN KEY (`dive_site_id`) REFERENCES `dive_sites` (`id`) ON DELETE CASCADE,
  CONSTRAINT `dive_site_entries_entry_id_foreign` FOREIGN KEY (`entry_id`) REFERENCES `dive_entries` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `dive_site_equipments`
--

DROP TABLE IF EXISTS `dive_site_equipments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dive_site_equipments` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `dive_site_id` bigint(20) unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `dive_site_equipments_dive_site_id_foreign` (`dive_site_id`),
  KEY `dive_site_equipments_equipment_id_foreign` (`equipment_id`),
  CONSTRAINT `dive_site_equipments_dive_site_id_foreign` FOREIGN KEY (`dive_site_id`) REFERENCES `dive_sites` (`id`) ON DELETE CASCADE,
  CONSTRAINT `dive_site_equipments_equipment_id_foreign` FOREIGN KEY (`equipment_id`) REFERENCES `equipments` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `dive_site_images`
--

DROP TABLE IF EXISTS `dive_site_images`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dive_site_images` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `dive_site_images_dive_site_id_foreign` (`dive_site_id`),
  CONSTRAINT `dive_site_images_dive_site_id_foreign` FOREIGN KEY (`dive_site_id`) REFERENCES `dive_sites` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `dive_site_nearby`
--

DROP TABLE IF EXISTS `dive_site_nearby`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dive_site_nearby` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `owner_site_id` bigint(20) unsigned NOT NULL,
  `nearby_site_id` bigint(20) unsigned NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `dive_site_nearby_owner_site_id_foreign` (`owner_site_id`),
  KEY `dive_site_nearby_nearby_site_id_foreign` (`nearby_site_id`),
  CONSTRAINT `dive_site_nearby_nearby_site_id_foreign` FOREIGN KEY (`nearby_site_id`) REFERENCES `dive_sites` (`id`) ON DELETE CASCADE,
  CONSTRAINT `dive_site_nearby_owner_site_id_foreign` FOREIGN KEY (`owner_site_id`) REFERENCES `dive_sites` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `dive_site_seasons`
--

DROP TABLE IF EXISTS `dive_site_seasons`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dive_site_seasons` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `dive_site_id` bigint(20) unsigned NOT NULL,
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `dive_site_seasons_dive_site_id_foreign` (`dive_site_id`),
  KEY `dive_site_seasons_season_id_foreign` (`season_id`),
  CONSTRAINT `dive_site_seasons_dive_site_id_foreign` FOREIGN KEY (`dive_site_id`) REFERENCES `dive_sites` (`id`) ON DELETE CASCADE,
  CONSTRAINT `dive_site_seasons_season_id_foreign` FOREIGN KEY (`season_id`) REFERENCES `seasons` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `dive_site_taxons`
--

DROP TABLE IF EXISTS `dive_site_taxons`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dive_site_taxons` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `dive_site_id` bigint(20) unsigned NOT NULL,
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `dive_site_taxons_dive_site_id_foreign` (`dive_site_id`),
  KEY `dive_site_taxons_taxon_id_foreign` (`taxon_id`),
  CONSTRAINT `dive_site_taxons_dive_site_id_foreign` FOREIGN KEY (`dive_site_id`) REFERENCES `dive_sites` (`id`) ON DELETE CASCADE,
  CONSTRAINT `dive_site_taxons_taxon_id_foreign` FOREIGN KEY (`taxon_id`) REFERENCES `taxons` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `dive_sites`
--
...
CREATE TABLE `dive_sites` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `latitude` decimal(10,8) NOT NULL DEFAULT '28.48893000',
  `longitude` decimal(11,8) NOT NULL DEFAULT '34.50156000',
  `max_depth` int(11) NOT NULL DEFAULT '0',
  `visibility` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'High',
  `current` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Low',
  `city_id` bigint(20) unsigned NOT NULL,
  `main_taxon_id` bigint(20) unsigned NOT NULL,
  `license_id` bigint(20) unsigned NOT NULL,
  `enabled` tinyint(1) NOT NULL DEFAULT '0',
  `special` tinyint(1) NOT NULL DEFAULT '0',
  `guided` tinyint(1) NOT NULL DEFAULT '0',
  `rate` int(11) NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `dive_sites_city_id_foreign` (`city_id`),
  KEY `dive_sites_main_taxon_id_foreign` (`main_taxon_id`),
  KEY `dive_sites_license_id_foreign` (`license_id`),
  CONSTRAINT `dive_sites_city_id_foreign` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`) ON DELETE CASCADE,
  CONSTRAINT `dive_sites_license_id_foreign` FOREIGN KEY (`license_id`) REFERENCES `diving_courses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `dive_sites_main_taxon_id_foreign` FOREIGN KEY (`main_taxon_id`) REFERENCES `taxons` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `diving_courses`
--

DROP TABLE IF EXISTS `diving_courses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `diving_courses` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `school_id` bigint(20) unsigned NOT NULL,
  `license_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `required_license_id` bigint(20) unsigned DEFAULT NULL,
  `days_num` int(11) NOT NULL DEFAULT '0',
  `learning_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `enabled` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `diving_courses_school_id_foreign` (`school_id`),
  KEY `diving_courses_required_license_id_foreign` (`required_license_id`),
  CONSTRAINT `diving_courses_required_license_id_foreign` FOREIGN KEY (`required_license_id`) REFERENCES `diving_courses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `diving_courses_school_id_foreign` FOREIGN KEY (`school_id`) REFERENCES `diving_schools` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `diving_schools`
--

DROP TABLE IF EXISTS `diving_schools`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `diving_schools` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `equipments` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `night_dive` tinyint(1) NOT NULL DEFAULT '0',
  `nitrox` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `equipments_season_id_foreign` (`season_id`),
  CONSTRAINT `equipments_season_id_foreign` FOREIGN KEY (`season_id`) REFERENCES `seasons` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `package_courses` (
  ...
  CONSTRAINT `package_courses_course_id_foreign` FOREIGN KEY (`course_id`) REFERENCES `diving_courses` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_licenses` (
  ...
  KEY `user_licenses_course_id_foreign` (`course_id`),
  CONSTRAINT `user_licenses_course_id_foreign` FOREIGN KEY (`course_id`) REFERENCES `diving_courses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `user_licenses_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `default_license` bigint(20) unsigned DEFAULT NULL,
  `remember_token` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  ...
  KEY `users_default_license_foreign` (`default_license`),
  ...
  CONSTRAINT `users_default_license_foreign` FOREIGN KEY (`default_license`) REFERENCES `user_licenses` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-12-12 18:18:56
