            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('day-times.index')}}">Home</a></li>
                        <li class="breadcrumb-item active">Day times</li>
                    </ol>
                </div>
                <div class="col-sm-12">

                    <a class="float-sm-right" href="{{route('day-times.create')}}">Add a new Day time</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
