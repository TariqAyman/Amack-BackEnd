...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Dive Activities</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('dive-activities.index')}}">Home</a></li>
                        <li class="breadcrumb-item active">Dive Activities</li>
                    </ol>
                </div>
                <div class="col-sm-12">

                    <a class="float-sm-right" href="{{route('dive-activities.create')}}">Add a new Dive Activity</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
