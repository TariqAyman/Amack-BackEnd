            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4 class="card-title">Dive Activities</h4>
                        <div class="dt-action-buttons text-right">
                            <div class="dt-buttons flex-wrap d-inline-flex">
                                ...
                                @if(Auth::user()->can('dive-activities.create'))
                                    <a class="btn create-new btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button" href="{{route('dive-activities.create')}}">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
    ...
    <script type="text/javascript">
        var dataTable = $('#datatable').DataTable({
            ...
            ajax: {
                ...
                url: '{{route('dive-activities.data')}}',
                type: "POST"
            }, columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name'},
        ...
        function deleteItem(id) {
            let url = '{{route('dive-activities.destroy','#id')}}';
