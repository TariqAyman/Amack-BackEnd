...
<div class="main-menu menu-fixed {{($configData['theme'] === 'dark') ? 'menu-dark' : 'menu-light'}} menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item  {{ Route::is('dive-sites.index') ? 'active' : '' }}">
            ...
            <li class="nav-item  {{ Route::is('cities.index') ? 'active' : '' }}">
            ...
            <li class="nav-item  {{ Route::is('equipments.index') ? 'active' : '' }}">
            ...
            <li class="nav-item  {{ Route::is('centers.index') ? 'active' : '' }}">
            ...
            <li class="nav-item  {{ Route::is('staff.index') ? 'active' : '' }}">
            ...
            <li class="nav-item has-sub {{ Route::is('staff.index') ? 'active' : '' }}" style="">
                ...
                <ul class="menu-content">
                    <li class="{{ Route::is('staff.index') ? 'active' : '' }}">
                    ...
                    <li class="{{ Route::is('dive-activities.index') ? 'active' : '' }}">
                    ...
                    <li class="{{ Route::is('dive-entries.index') ? 'active' : '' }}">
                    ...
                    <li class="{{ Route::is('schools.index') ? 'active' : '' }}">
                    ...
                    <li class="{{ Route::is('countries.index') ? 'active' : '' }}">
