...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{isset($data)? 'Edit Taxon '.$data->id : 'New Taxon'}}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{route('taxons.index')}}">Taxons</a></li>
                        <li class="breadcrumb-item active">{{isset($data)? 'Edit Taxon' : 'New Taxon'}}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <form method="post" enctype="multipart/form-data"
                              action="{{isset($data)? route('taxons.update',$data->id):route('taxons.store')}}"
                              role="form">
                            @if(isset($data))
                                @method('PUT')
                            @endif
